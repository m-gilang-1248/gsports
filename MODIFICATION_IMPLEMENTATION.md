# Implementation Plan: UI Building Blocks & Dependencies
...
- [ ] Create the directory `lib/core/presentation/widgets/`.
- [ ] Create the file `lib/core/presentation/widgets/app_colors.dart`.
- [ ] Define the `AppColors` class with `primary`, `accent`, `surface`, `border`, `success`, `error`, and `warning` static Color constants as per the design document.
